...
parser.add_argument("--gloo_socket_ifname", default="wlxf46d2f96416c")
parser.add_argument("--tp_socket_ifname", default="wlxf46d2f96416c")
...
if __name__ == "__main__":
    ...
    server = Server("mlp", "mnist", "iid", 0.05, 2, 5)
    server.train()
